...
public class ForkliftElevator extends ForkliftPart
{
    ...
    /*
     * @Override public boolean setJagVoltage(double voltage) { if (voltage < 0 &&
     * this.isLowLimitSwitchClosed()) { return false; } else if (voltage > 0 &&
     * this.isHighLimitSwitchClosed()) { return false; } return super.setJagVoltage(voltage); }
     */
}
