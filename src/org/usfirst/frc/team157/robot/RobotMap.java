...
/**
 * Defines all of the hardware port numbers for each hardware component, and then constructs each
 * component for use by other subsystems. This makes it easy for one to change the IDs
 *
 * @author Teju Nareddy
 *
 */
public class RobotMap
{
    ...
    // Jag Scaling Values. If the Jags are too fast or slow, changing this value will change the
    // Jag's speed in every single file.
    ...
    // Limit Switches IsReversed variables -- If the wiring of the limit switch is backward, set
    // this to true for the robot to
    ...
    {
        // Instantiate all of the jaguars with the scaling factors and IDs. Surround with try/catch
        // in case the jaguars are not
        // plugged in. This way, the whole robot will not crash, only the individual jaguar will be
        // disabled.
        try
        {
